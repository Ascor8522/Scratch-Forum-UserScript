(function() {
    'use strict';
    console.log("Scratch-Forum-UserScript by Smrman | update 23-05-17 22:00 GMT+1");
    ...
    if (urlcourt=="https://scratch.mit.edu/discuss/topic/" || urlcourt=="https://scratch.mit.edu/discuss/settings/"){
    		console.log("discuss");
		var range, sel;
		// == Ascor Logo ==
